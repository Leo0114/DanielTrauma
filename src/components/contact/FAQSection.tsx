      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <ScrollReveal direction="up">
          <div className="text-center mb-12">
            ...
            <p className="text-text-muted dark:text-slate-400 font-body max-w-xl mx-auto">
              Consultorios ubicados en Monterrey, Nuevo León, con fácil acceso y estacionamiento.
            </p>
          </div>
        </ScrollReveal>
            ...
            <ScrollReveal key={office.id} delay={index * 0.1} direction="up">
              <div className={`p-7 rounded-2xl border transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full ${
                ...
                <div className="flex items-start gap-3 mb-4">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
                ...
                <div className="flex items-center gap-3 mb-5">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-primary flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <a href={`tel:${office.phone}`} className="text-sm font-semibold text-primary hover:underline underline-offset-2 font-body transition-colors duration-200">
                    {office.phone}
                  </a>
                </div>
                ...
                <div className="space-y-2 mb-6">
                  ...
                  {office.schedule.map((slot) => (
                    <div key={slot.days} className="flex justify-between gap-3 text-sm font-body">
                      <span className="text-text dark:text-slate-300">{slot.days}</span>
                      <span className="text-text-muted dark:text-slate-400 text-right">{slot.hours}</span>
                    </div>
                  ))}
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-white" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap gap-3">
            {contactHero.trustPoints.map((point) => (
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5} aria-hidden="true">
